      ...
      <div className="inner-width-section ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-24">
          ...
          <div className="space-y-4">
            ...
            {/* Card 1 */}
          <Link href="/permanent">  <div className="bg-[#0A2E5C] mb-2 text-white p-6 rounded-lg flex items-center justify-between  transition cursor-pointer">
                <div>
            ...
            {/* Card 2 */}
          <Link href="/locum">   <div className="bg-[#0A2E5C] mb-2 text-white p-6 rounded-lg flex items-center justify-between  transition cursor-pointer">
              <div>
            ...
            {/* Card 3 */}
            <Link href="/international">    <div className="bg-[#0A2E5C] text-white p-6 rounded-lg flex items-center justify-between  transition cursor-pointer">
              <div>
