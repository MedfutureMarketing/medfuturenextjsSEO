...
interface RecruitmentCard {
    ...
    description: string;
    iconBgColor: string;
    coverImage: any; // Next.js StaticImageData
}
...
const StethoscopeSVG = () => (
    ...
    <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M24.8879 32.0336C29.7672 32.0336 33.7231 28.4068 33.7231 24.2841C33.7231 20.1613 29.7672 17.1055 24.8879 17.1055C20.0087 17.1055 16.0527 20.4474 16.0527 24.5701C16.0527 26.1792 16.6557 27.6702 17.6817 28.8883L16.6049 33.9476L20.9298 31.2451C22.183 31.7705 23.529 32.0387 24.8879 32.0336Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
    ...
    return (
        <div className="w-full bg-white px-6 py-12 lg:px-0">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-blue-900 whitespace-nowrap">
            ...
            {/* Header Section */}
            <div className="mb-12">
                <p className="text-sm text-gray-600 mb-2 font-medium">Explore by divisions</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {cards.map((card, index) => (
                    <div key={index} className="flex flex-col bg-white rounded-lg shadow-sm overflow-hidden">
                        {/* Image - Top Section with Next.js Image */}
                        ...
                        <div className="flex-1 flex flex-col p-4">
                            {/* Icon Badge - Positioned at top with negative margin */}
                            <div className="flex items-center gap-3 mb-3 -mt-8 relative z-10">
                                <div
                                    className={`${card.iconBgColor} rounded-full p-0 flex items-center justify-center flex-shrink-0 text-white shadow-md`}
                                >
                                    {card.iconSvg}
                                </div>
                            </div>
                            ...
                            {/* Title */}
                            <h3 className="text-base lg:text-[16px] font-bold text-[#0F172A] mb-2">
                                {card.title}
                            </h3>

                            {/* Description */}
                            <p className="text-sm lg:text-[14px] text-[#4A5565] mb-4 flex-grow leading-relaxed">
                                {card.description}
                            </p>

                            {/* Explore Button */}
                            <button className="w-full bg-[#074CA4] hover:bg-blue-800 text-white font-semibold py-3 px-4 rounded transition-colors duration-200">
                                Explore
                            </button>
                        </div>
                    </div>
