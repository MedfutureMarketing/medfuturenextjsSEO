      ...
      <div className="inner-width-section mx-auto space-y-10">
        ...
        <div className="text-center">
          <h2 className="text-2xl lg:text-[40px] font-bold text-gray-800 mb-4">
            Featured <span className="text-[#074CA4]">General Practitioner Registrar Roles</span>
          </h2>

          <p className="text-gray-600 text-xs text-center mx-auto lg:w-[792px] lg:text-[16px]">
These roles support structured training while allowing registrars to build confidence through hands on clinical practice. Opportunities exist across metropolitan regional and rural settings to suit different training goals and lifestyles.
          </p>
        </div>
