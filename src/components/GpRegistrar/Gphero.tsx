...
export default function GpHeroSection() {
    return (
            ...
            <div className="inner-width-section mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                ...
                <div className="lg:col-span-2 space-y-[32px]">
                    <h1 className="text-2xl lg:text-[36px] font-bold">
                        Advance Your Career as a General <br /> Practitioner Registrar in Australia
                    </h1>
                    <p className="text-xs lg:text-[16px] text-white/80 max-w-lg">
                        Begin your professional journey as a General Practitioner Registrar in Australia, gaining structured training, diverse clinical exposure, and progressive responsibilities that build confidence, competence, and readiness for independent general practice across varied healthcare settings.
                    </p>
