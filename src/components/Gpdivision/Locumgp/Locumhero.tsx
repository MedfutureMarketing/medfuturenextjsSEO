...
const HeroSection = () => {
                    ...
                    <div className="flex flex-col  justify-center ">
                        <div className="">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/locum/general-practitioner-jobs/in-australia?page=1" className="inline-flex cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-white text-[#040D48] font-[500] rounded-[8px] hover:bg-gray-100 transition w-full sm:w-auto">
                                ...
                                <Link href="/contact-us" className="inline-flex items-center cursor-pointer gap-2 justify-center px-6 py-3 border border-white text-white font-semibold rounded-lg hover:bg-gray-500 h transition w-full sm:w-auto">
                            ...
                            <div className="flex flex-wrap gap-4 mt-[40px]  justify-start">
                                <div className="
        bg-white/21 border border-gray-500 border-opacity-20
        rounded-lg p-5 backdrop-blur-sm lg:block hidden
        w-full
        sm:w-[48%]
        lg:w-[192px]
    ">
                                    <h3 className="text-[14px] text-white mb-2">
                                        One-profile credential approach
                                    </h3>
                                </div>
    ...
    ">
                                    <h3 className="text-[14px] text-white mb-2">
                                        Fast starts when docs are ready
                                    </h3>
                                </div>
