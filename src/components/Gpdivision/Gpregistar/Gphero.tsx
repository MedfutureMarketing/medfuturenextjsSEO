...
AHPRA-registered Non‑VR GP or GP Registrar? Medfuture sources training-aligned GP roles across MMM1–MMM7 with verified supervision, realistic rosters, and rural opportunities designed for fellowship success.                                </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <Link href="/contact" className="inline-flex items-center lg:text-[14px] text-sm cursor-pointer gap-2 justify-center px-6 py-3 border border-white text-white  rounded-lg hover:bg-gray-500 h transition w-full sm:w-auto">
