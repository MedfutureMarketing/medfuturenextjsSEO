            ...
            <div className="inner-width-section mx-auto lg:py-[36px] py-4"><div className=" px-0 lg:px-0 md:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.9fr] gap-8 lg:gap-24 items-start">
                    ...
                    <div className="flex flex-col justify-center ">
                        <div className="">
                            <div className="">
                                <h1 className="text-2xl md:text-2xl mt-6 lg:text-[32px] font-bold text-white leading-tight">
                                   GP Training Program Jobs in Australia  </h1>

                                <p className="lg:text-[16px] text-xs text-gray-200 max-w-2xl mt-[29px] mb-[40px] leading-relaxed">
AHPRA-registered Non‑VR GP or GP Registrar? Medfuture sources training-aligned GP roles across MMM1–MMM7 with verified supervision, realistic rosters, and rural opportunities designed for fellowship success.                                </p>
                            </div>

                            {/* CTA BUTTONS */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent/gp-registrar-jobs/in-australia?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-white text-[#040D48] font-[500] rounded-[8px] hover:bg-gray-100 transition w-full sm:w-auto">
                                ...
                                Browse GP Registrar Jobs
                                </Link>

                                <Link href="/contact-us" className="inline-flex items-center lg:text-[14px] text-sm cursor-pointer gap-2 justify-center px-6 py-3 border border-white text-white  rounded-lg hover:bg-gray-500 h transition w-full sm:w-auto">
