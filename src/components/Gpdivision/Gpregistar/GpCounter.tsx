...
const counterData: CounterItem[] = [
  { value: 2000, label: "Active GP Registrar Jobs", suffix: "+" },
  { value: 9000, label: "GP Registrars in Talent Pool", suffix: "+" },
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full">
        ...
        <div className="text-center">
          <div className="text-base xs:text-lg sm:text-2xl md:text-2xl lg:text-[30px] font-bold text-slate-900 tracking-tight whitespace-nowrap">
