                    ...
                    <div className="flex flex-col justify-center ">
                        <div className="">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button className="inline-flex items-center gap-2 justify-center px-6 py-3 bg-white text-[#040D48] font-[500] rounded-[8px] hover:bg-gray-100 transition w-full sm:w-auto">
                                ...
                                <button className="inline-flex items-center gap-2 justify-center px-6 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover: transition w-full sm:w-auto">
