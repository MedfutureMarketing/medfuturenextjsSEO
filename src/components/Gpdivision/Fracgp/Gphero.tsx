    ...
    return (
        <section className="bg-[#040D48] full-width-section">
            <div className="inner-width-section mx-auto py-10 sm:py-12 lg:py-[36px] px-4 sm:px-6">
                <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.9fr] lg:px-0 md:px-8 px-0 gap-8 lg:gap-24 items-start">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-4 mt-10 justify-start">
                            <div className="bg-white/11 border hidden lg:block border-gray-500 border-opacity-20 rounded-lg p-5 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                            ...
                            <div className="bg-white/11 hidden lg:block border border-gray-500 border-opacity-20 rounded-lg p-5 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                    ...
                    {/* RIGHT FORM */}
                    <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-6 lg:p-6 md:p-0 h-fit lg:sticky top-8">
                        <FormComponent />
                    </div>
