          ...
          <div className="space-y-2 flex-1">
            ...
            {job.profession_name && (
                <div className="flex items-center gap-2 xs:gap-3">
                    ...
                    <p className="text-[11px] xs:text-xs sm:text-sm lg:text-[14px] text-[#0F172A] ">{job.profession_name}</p>
                </div>
            )}
            ...
            {job.engagement_type_name && (
                <div className="flex items-center gap-2 xs:gap-3">
                    ...
                    <p className="text-[11px] xs:text-xs sm:text-sm lg:text-[14px] text-[#0F172A] ">{job.engagement_type_name}</p>
                </div>
            )}
            ...
            {job.hourly_fee && (
                <div className="flex items-center gap-2 xs:gap-3">
                    ...
                    <p className="text-[11px] xs:text-xs sm:text-sm lg:text-[14px] text-[#0F172A] ">{job.hourly_fee}</p>
                </div>
            )}
          </div>
...
<div className=" px-0 lg:px-0 md:px-8">
        ...
        <div className="lg:hidden mb-6">
          <div
            ...
            className="flex overflow-x-scroll snap-x snap-mandatory scroll-smooth gap-4 pb-0 -mx-3 px-3 scrollbar-hide"
          >
            {jobs.map((job, index) => (
              <div
