    ...
    <div className="hidden lg:block md:block border-2" id="job-description-wrapper">
      ...
      <div className="relative px-5">
        <div className="absolute top-0 right-0 px-5">
         <Link href={`/international/job/${job.job_id}`} className="hover:underline ">  <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex items-center gap-3 mt-[24px] mb-[20px] lg:px-[44px] px-[25px]">
        <span className="text-[#0E2851] lg:text-[18px]">International</span>
