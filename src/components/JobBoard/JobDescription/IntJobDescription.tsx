    ...
    <div className="hidden lg:block md:block border-2" id="job-description-wrapper">
      ...
      <div className="relative px-5 mb-6">
        <div className="absolute top-0 right-0 px-5">
          <Link href={`/international/job/${job.job_id}`} className="hover:underline">
      ...
      <div className="flex items-center gap-3 mt-[24px] mb-[20px] lg:px-[44px] px-[25px]">
        <span className="text-[#0F172A] lg:text-[16px]"><Image src={Permenentico} alt="Permanent" className=" mr-0 inline-block" /> International</span>
        <span className="text-[#0F172A] lg:text-[16px]"><Image src={Doctorico} alt="Permanent" className=" mr-0 inline-block" />{job.profession?.name}</span>
        <span className="text-[#0F172A] lg:text-[16px]"><Image src={Moneyico} alt="Permanent" className=" mr-0 inline-block" />{job.engagement_type?.name}</span>
        <span className="text-[#0F172A] lg:text-[16px]"><Image src={Timeico} alt="Permanent" className=" mr-0 inline-block" />
      ...
      <div className="prose max-w-none lg:px-[44px] px-[25px]">
        <p className="text-[#666] text-[16px]">{job.job_brief}</p>

        <h4 className="font-bold text-[#040D48] mt-[40px]">Offer Details</h4>
        {job.highlights?.length > 0 && (
          <ul className="list-disc text-[16px] list-inside text-[#666] mt-[10px] space-y-1">
        ...
        <h3 className="font-semibold text-[#0F172A] mt-[40px]">Medical Practice Details</h3>
        <p className="text-[#666] mt-[10px]">{job.medical_practise_details}</p>

        <h4 className="font-semibold text-[#0F172A] mt-[40px]">Eligibility Requirements</h4>
      ...
      <div className="mt-6 lg:mt-10 px-[44px]">
