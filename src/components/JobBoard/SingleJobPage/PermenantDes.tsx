  ...
  return (
    <div className="rounded-8px relative">
      ...
      <div className="full-width-section bg-[#0A2E5C] lg:h-[113px] relative">
        <div className="absolute left-0 bottom-0 w-[182px] h-[182px] lg:block hidden pointer-events-none">
          <Image
            src={Jobboard1}
        ...
        <div className="absolute right-0 bottom-0 w-32 h-32 lg:block hidden pointer-events-none">
          <Image
            src={Jobbaord2}
      ...
      {/* Job Tags */}
      <div className="inner-width-section mt-[16px] lg:mt-[24px] mb-[16px] lg:mb-[20px] px-4 lg:px-0 flex flex-wrap items-center gap-2 lg:gap-3">
        <span className="text-[#0E2851] lg:text-[18px] text-[13px] px-2 lg:px-0 py-1 lg:py-0 rounded bg-gray-100 lg:bg-transparent flex items-center gap-1">
          <Image src={Permenentico} alt="Permanent" className="mr-0 inline-block" />
          Permanent
        </span>
        <span className="text-[#0E2851] lg:text-[18px] text-[13px] px-2 lg:px-3 py-1 lg:py-0 rounded bg-gray-100 lg:bg-transparent flex items-center gap-1">
          <Image src={Doctorico} alt="Doctor" className="mr-0 inline-block" />
          {job.profession?.name}
        </span>
        <span className="text-[#0E2851] lg:text-[18px] text-[13px] px-2 lg:px-3 py-1 lg:py-0 rounded bg-gray-100 lg:bg-transparent flex items-center gap-1">
          <Image src={Moneyico} alt="Money" className="mr-0 inline-block" />
          {job.engagement_type?.name}
        </span>
        <span className="text-[#0E2851] lg:text-[18px] text-[13px] px-2 lg:px-3 py-1 lg:py-0 rounded bg-gray-100 lg:bg-transparent flex items-center gap-1">
          <Image src={Timeico} alt="Time" className="mr-0 inline-block" />
