    ...
    <div className="full-width-section bg-white font-sans">
      ...
      <div className="inner-width-section mx-auto px-4 sm:px-6 lg:px-10 py-6 sm:py-8 lg:py-10 flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
        ...
        <div className="flex-1 min-w-0 w-full">
          ...
          {/* Heading */}
          <h1 className="text-2xl  lg:text-[36px] font-bold text-[#040D48] leading-tight mb-3 sm:mb-3.5 max-w-lg">
            Employer Hub — Healthcare Recruitment Australia
          </h1>

          {/* Subheading */}
          <p className="text-xs lg:text-[20px] text-slate-700 font-[500] mb-3 sm:mb-4">
            Workforce solutions built for continuity, compliance and growth.
          </p>

          {/* Body */}
          <p className="text-xs lg:text-[16px] text-[#4A5565] leading-relaxed mb-6 lg:mb-[31px] mt-[31px] max-w-[600px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {featureCards.map((card) => (
              ...
              >
                <p className="lg:text-[12px] text-xs text-[#4A5565] font-medium mb-1.5">{card.label}</p>
                <p className="lg:text-[14px] text-xs font-[500] text-[#0F172A] leading-snug">{card.title}</p>
              </div>
            ))}
          </div>
        </div>
