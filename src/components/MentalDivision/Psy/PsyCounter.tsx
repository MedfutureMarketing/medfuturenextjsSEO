...
interface ProfessionPageResponse {
  psychologistJobCounts: number; // 👈 changed
    ...
    async function fetchProfessionData() {
      try {
        ...
        const updatedCounters: CounterItem[] = [
          {
            value: res.psychologistJobCounts,
            label: "Active Specialist Psychologist Jobs",
            suffix: "+",
          },
          {
            value: 9000,
            label: "Top-rated Psychologist in Talent Pool",
            suffix: "+",
          },
          {
            value: 8,
