                        ...
                        <div className="">
                            <div className="">
                                <h1 className="text-2xl md:text-2xl lg:text-[32px] font-bold text-white leading-tight">
                                    Psychologist Jobs in Australia — career-safe roles built around your practice.</h1>

                                <p className="lg:text-[16px] text-xs text-gray-200 max-w-2xl mt-[29px] mb-[40px] leading-relaxed">
                                    Medfuture matches AHPRA-registered Psychologists to ethical opportunities with transparent expectations—caseload reality, admin time, supervision pathways, and supportive teams. No pressure. No fast-talking. Just professional alignment
                                </p>
                            </div>

                            {/* CTA BUTTONS */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent/psychology-jobs/in-australia?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-white text-[#040D48] font-[500] rounded-[8px] hover:bg-gray-100 transition w-full sm:w-auto">
                                    ...
                                    Browse Psychology Jobs
                                </Link>

                                <Link href="/contact-us" className="inline-flex lg:text-[14px] text-sm items-center cursor-pointer gap-2 justify-center px-6 py-3 border border-white text-white font-semibold rounded-lg hover:bg-gray-500 h transition w-full sm:w-auto">
                            ...
                            <div className="flex flex-wrap gap-4 mt-[40px] justify-start">
                                <div className="bg-white/21 border lg:block hidden border-gray-500 border-opacity-20 rounded-lg p-5 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                                    <h3 className="text-[14px] text-white mb-2">NDIS</h3>
                                    <p className="text-xs text-gray-200">
                                        Neurodiversity-focused pathways
                                    </p>
                                </div>

                                <div className="bg-white/21 lg:block hidden  border border-gray-500 border-opacity-20 rounded-lg p-5 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                                    <h3 className="text-[14px] text-white mb-2">Hospitals</h3>
                                    <p className="text-xs text-gray-200">
                                        Governance & MDT support
                                    </p>
                                </div>

                                <div className="bg-white/21 lg:block hidden  border border-gray-500 border-opacity-20 rounded-lg p-5 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                                    <h3 className="text-[14px] text-white mb-2">Telehealth
