        ...
        <>
            <section className="relative full-width-section w-full overflow-hidden py-10 sm:py-14 lg:py-16 px-4 sm:px-6 -mt-11">
                ...
                <div className="relative mx-auto inner-width-section">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-[40px]  lg:gap-12  ">

                        {/* Left Content */}
                        <div className="lg:col-span-7">
                            <h1 className="text-xl sm:text-xl lg:text-[36px] lg:mt-[68px]  mt-10   font-bold mb-4 lg:mb-6 leading-snug lg:leading-tight">
                                Mental Health Recruitment Hub Australia

                            </h1>

                            <p className="text-sm sm:text-base md:text-[16px] lg:mt-[48px] mb-[40px] lg:mb-8 text-gray-200 max-w-2xl leading-relaxed">
