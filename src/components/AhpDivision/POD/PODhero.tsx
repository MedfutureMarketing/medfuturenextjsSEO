                            ...
                            <div className="">
                                <div className="">
                                    <h1 className="text-2xl md:text-2xl lg:text-[32px] font-bold text-[#040D48] leading-tight">
                                        Podiatrist Jobs in Australia — Clinically Aligned, Ethical & Transparent
                                    </h1>
                                    <p className="lg:text-[16px] text-xs text-[#4A5565] max-w-2xl mt-[29px] mb-[40px] leading-relaxed">
                                        If you’re an AHPRA-registered Podiatrist, your next role isn’t just about salary. It’s about caseload sustainability, clinical autonomy, and a KPI model you can live with. Medfuture matches podiatrists to clinics with clarity—so you can visualise your day-to-day before you commit.
                                    </p>
                                </div>
                                {/* CTA BUTTONS */}
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <Link href="/permanent/podiatrist-jobs/in-australia?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-[#074CA4] text-white font-[500] rounded-[8px] hover:bg-[#074CA4]/80 transition w-full sm:w-auto">
                                ...
                                <div className="flex flex-wrap gap-4 mt-[40px] justify-start">
                                    <div className="bg-[#074CA4]/8 border lg:block hidden border-gray-300 border-opacity-20 rounded-lg py-6 px-3 backdrop-blur-sm flex-1 min-w-[192px] max-w-[192px]">
                                        <h3 className="text-[14px] text-[#040D48] font-[700]">Metro roles</h3>
