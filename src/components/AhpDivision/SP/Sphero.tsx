                        ...
                        <div className="">
                            <div className="">
                                <h1 className="text-2xl md:text-2xl lg:text-[32px] font-bold text-[#040D48] leading-tight">
                                    Speech Therapist Jobs Australia — built around your caseload, supervision & wellbeing.
                                </h1>

                                <p className="lg:text-[16px] text-xs text-[#4A5565] max-w-2xl mt-[29px] mb-[40px] leading-relaxed">
                                    Medfuture helps SPA-aligned Speech Pathologists find roles that match their clinical interests and workload reality — from paediatric NDIS and schools to adult dysphagia, neuro and telehealth.
                                </p>
                            </div>

                            {/* CTA BUTTONS */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent/speech-pathologist-jobs/in-australia?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-[#074CA4] text-white font-[500] rounded-[8px] hover:bg-[#074CA4]/80 transition w-full sm:w-auto">
                            ...
                            <div className="flex flex-wrap gap-4 mt-[40px] justify-start">
                                <div className="bg-[#074CA4]/8 border lg:block hidden border-gray-100 border-opacity-20 rounded-lg p-5 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                                    <h3 className="text-[12px] text-[#040D48] mb-2">Caseload clarity</h3>
                                    <p className="text-[14px] text-[#040D48] font-[700]">
                                        Before interviews                                    </p>
                                </div>
