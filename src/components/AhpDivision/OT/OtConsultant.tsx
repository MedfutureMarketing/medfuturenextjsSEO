        ...
        consultants: [
             {
                id: "1",
                name: "Sarah Anderson",
                title: "Team Leader -AHP Unit",
                email: "sarah@medfuture.com.au",
                phone: "+61 489 079 185",
                location: "NSW",
            },
            {
                id: "2",
                name: "Hailey N",
                title: "Consultant - Account Management & Corporate Relations",
                email: "hailey@medfuture.com.au",
                phone: "+61 489 076 618",
                location: "QLD",
            },
            {
                id: "3",
                name: "Rosh Mckenzie",
                title: "Business Development Executive cum Para Consultant ",
                email: "rosh@medfuture.com.au",
            ...
            },
            {
                ...
                email: "eleesha@medfuture.com.au",
                phone: "+61 489 078 475",
                location: "Queensland",
            },
            // {
            //     id: "6",
...
export default async function ConsultantsPage() {
  ...
  {/* Header */}
  <div className="px-4 sm:px-6 inner-width-section lg:px-0 py-8 lg:py-[83px]">       <div className=" px-0 lg:px-0 md:px-8">
