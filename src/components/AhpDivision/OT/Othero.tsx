            ...
            <div className="inner-width-section mx-auto lg:py-[36px] py-12"><div className=" px-0 lg:px-0 md:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.9fr] gap-8 lg:gap-36 items-start">
                    ...
                    <div className="flex flex-col justify-center ">
                        <div className="">
                            <div className="">
                                <h1 className="text-2xl md:text-2xl lg:text-[32px] font-bold text-[#040D48] leading-tight">
                                    Occupational Therapist jobs in Australia that respect your caseload, clinical judgement, and wellbeing.
                                </h1>

                                <p className="lg:text-[16px] text-xs text-[#4A5565] max-w-2xl mt-[29px] mb-[40px] leading-relaxed">
                                    Medfuture specialises in OT roles across NDIS & community, paediatrics, hospitals & rehab, and mental health. We verify the real-world details that matter to OTs—caseload, billables, admin time, supervision, and flexibility—before you apply.
                                </p>
                            </div>

                            {/* CTA BUTTONS */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent/occupational-therapists-jobs/in-australia?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-[#074CA4] text-white font-[500] rounded-[8px] hover:bg-[#074CA4]/80 transition w-full sm:w-auto">

                                    <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.5 13.5417C4.68333 13.5417 3.146 12.8861 1.888 11.575C0.63 10.2639 0.000667196 8.6625 5.29101e-07 6.77083C-0.000666138 4.87917 0.628667 3.27778 1.888 1.96667C3.14733 0.655556 4.68467 0 6.5 0C8.31533 0 9.853 0.655556 11.113 1.96667C12.373 3.27778 13.002 4.87917 13 6.77083C13 7.53472 12.8833 8.25521 12.65 8.93229C12.4167 9.60938 12.1 10.2083 11.7 10.7292L17.3 16.5625C17.4833 16.7535 17.575 16.9965 17.575 17.2917C17.575 17.5868 17.4833 17.8299 17.3 18.0208C17.1167 18.2118 16.8833 18.3073 16.6 18.3073C16.3167 18.3073 16.0833 18.2118 15.9 18.0208L10.3 12.1875C9.8 12.6042 9.225 12.934 8.575 13.1771C7.925 13.4201 7.23333 13.5417 6.5 13.5417ZM6.5 11.4583C7.75 11.4583 8.81267 11.0028 9.688 10.0917C10.5633 9.18056 11.0007 8.07361 11 6.77083C10.9993 5.46806 10.562 4.36146 9.688 3.45104C8.814 2.54063 7.75133 2.08472 6.5 2.08333C5.24867 2.08194 4.18633 2.53785 3.313 3.45104C2.43967 4.36424 2.002 5.47083 2 6.77083C1.998 8.07083 2.43567 9.17778 3.313 10.0917C4.19033 11.0056 5.25267 11.4611 6.5 11.4583Z" fill="white" />
                                    </svg>
                                    Browse OT Jobs
                                </Link>

                                <Link href="/contact-us" className="inline-flex lg:text-[14px] text-sm items-center cursor-pointer gap-2 justify-center px-6 py-3 border border-[#074CA4] text-[#074CA4] font-semibold rounded-lg hover:bg-gray-100 h transition w-full sm:w-auto">

                                    <svg width="15" height="20" viewBox="0 0 15 20" fill="#074CA4" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex flex-wrap gap-4 mt-[40px] justify-start">
                                <div className="bg-[#074CA4]/8 border lg:block hidden border-gray-100 border-opacity-20 rounded-lg py-6 px-3 backdrop-blur-sm flex-1 min-w-[192px] max-w-[192px]">
                                    <h3 className="text-[14px] text-[#040D48] font-[700]">Caseload safety first</h3>
                                    <p className="text-[12px] text-[#040D48] mt-[10px]">
                                        Role fit includes travel, cancellations, reporting load & admin protection.
                                    </p>
                                </div>

                                <div className="bg-[#074CA4]/8 border lg:block hidden border-gray-100 border-opacity-20 rounded-lg  py-6 px-3 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                                    <h3 className="text-[14px] text-[#040D48] font-[700]">Caseload safety first</h3>
                                    <p className="text-[12px] text-[#040D48] mt-[10px]">
                                        Billables, expectations and support clarified upfront—no surprises later.
                                    </p>
                                </div>
                                ...
                                <div className="bg-[#074CA4]/8 border lg:block hidden border-gray-100 border-opacity-20 rounded-lg  py-6 px-3 backdrop-blur-sm flex-1 min-w-[150px] max-w-[192px]">
                                    <h3 className="text-[14px] text-[#040D48] font-[700]">Caseload safety first</h3>
                                    <p className="text-[12px] text-[#040D48] mt-[10px]">
                                        Named supervisor + frequency confirmed before interviews.
                                    </p>
                                </div>
                            </div>
