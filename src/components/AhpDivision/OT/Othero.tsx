                    ...
                    <div className="flex flex-col justify-center ">
                        <div className="">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-[#074CA4] text-white font-[500] rounded-[8px] hover:bg-[#074CA4]/80 transition w-full sm:w-auto">
