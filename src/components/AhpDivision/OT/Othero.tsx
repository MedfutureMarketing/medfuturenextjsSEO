                    ...
                    <div className="flex flex-col justify-center ">
                        <div className="">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <Link href="/contact" className="inline-flex lg:text-[14px] text-sm items-center cursor-pointer gap-2 justify-center px-6 py-3 border border-[#074CA4] text-[#074CA4] font-semibold rounded-lg hover:bg-gray-100 h transition w-full sm:w-auto">
