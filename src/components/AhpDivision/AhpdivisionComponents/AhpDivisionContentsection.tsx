...
const AlliedHealthHub: React.FC<AlliedHealthHubProps> = ({ jobLinks = [] }) => {
    ...
    { title: 'Speech Pathologist Jobs Australia', url: '/permanent/speech-pathologist-jobs/in-australia?page=1' },
    { title: 'Speech Pathologist Jobs Victoria', url: '/permanent/speech-pathologist-jobs/in-victoria?page=1' },
    { title: 'Speech Pathologist Jobs NSW', url: '/permanent/speech-pathologist-jobs/in-nsw?page=1' },
    { title: 'Speech Pathologist Jobs Queensland', url: '/permanent/speech-pathologist-jobs/in-queensland?page=1' },
    { title: 'Speech Pathologist Jobs Western Australia', url: '/permanent/speech-pathologist-jobs/in-western-australia?page=1' },
    { title: 'Speech Pathologist Jobs South Australia', url: '/permanent/speech-pathologist-jobs/in-south-australia?page=1' },
    { title: 'Speech Pathologist Jobs ACT', url: '/permanent/speech-pathologist-jobs/in-act?page=1' },
    { title: 'Speech Pathologist Jobs Tasmania', url: '/permanent/speech-pathologist-jobs/in-tasmania?page=1' },
    { title: 'Occupational Therapist Jobs Australia', url: '/permanent/occupational-therapist-jobs/in-australia?page=1' },
    { title: 'Occupational Therapist Jobs NSW', url: '/permanent/occupational-therapist-jobs/in-nsw?page=1' },
    { title: 'Occupational Therapist Jobs Victoria', url: '/permanent/occupational-therapist-jobs/in-victoria?page=1' },
    { title: 'Occupational Therapist Jobs Queensland', url: '/permanent/occupational-therapist-jobs/in-queensland?page=1' },
    { title: 'Occupational Therapist Jobs Western Australia', url: '/permanent/occupational-therapist-jobs/in-western-australia?page=1' },
    { title: 'Occupational Therapist Jobs South Australia', url: '/permanent/occupational-therapist-jobs/in-south-australia?page=1' },
    { title: 'Physiotherapist Jobs Australia', url: '/permanent/physiotherapist-jobs/in-australia?page=1' },
    { title: 'Physiotherapist Jobs NSW', url: '/permanent/physiotherapist-jobs/in-nsw?page=1' },
    { title: 'Physiotherapist Jobs Victoria', url: '/permanent/physiotherapist-jobs/in-victoria?page=1' },
    { title: 'Physiotherapist Jobs Queensland', url: '/permanent/physiotherapist-jobs/in-queensland?page=1' },
    { title: 'Physiotherapist Jobs Western Australia', url: '/permanent/physiotherapist-jobs/in-western-australia?page=1' },
    { title: 'Physiotherapist Jobs Tasmania', url: '/permanent/physiotherapist-jobs/in-tasmania?page=1' },
 ];
