...
function CounterDisplay({ item }: CounterDisplayProps) {
  ...
  return (
    <div
      ref={elementRef}
      className="flex flex-col items-center justify-center min-h-[85px] xs:min-h-[90px] lg:min-h-[89px] rounded-lg border border-slate-200/60 bg-gradient-to-br from-[#074CA405] to-transparent hover:shadow-lg transition-all duration-300 hover:border-slate-300 p-3 xs:p-4 sm:p-5 mt-10 md:p-6 group"
    >
