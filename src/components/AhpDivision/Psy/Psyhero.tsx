                    ...
                    <div className="flex flex-col justify-center ">
                        <div className="">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-white text-[#040D48] font-[500] rounded-[8px] hover:bg-gray-100 transition w-full sm:w-auto">
