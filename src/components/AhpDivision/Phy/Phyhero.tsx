                        ...
                        <div className="">
                            <div className="">
                                <h1 className="text-2xl md:text-2xl lg:text-[32px] font-bold text-[#040D48] leading-tight">
                                    Physiotherapist Jobs in Australia — transparent KPIs, caseloads & mentoring
                                </h1>

                                <p className="lg:text-[16px] text-xs text-[#4A5565] max-w-2xl mt-[29px] mb-[40px] leading-relaxed">
                                    Most roles sound great until you start. Medfuture verifies the clinic reality: patient mix, session length, daily expectations, KPI model, admin time, supervision and progression—so you can move with confidence (again and again).
                                </p>
                            </div>

                            {/* CTA BUTTONS */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/permanent/physiotherapist-jobs/in-australia?page=1" className="inline-flex lg:text-[14px] text-sm cursor-pointer items-center gap-2 justify-center px-6 py-3 bg-[#074CA4] text-white font-[500] rounded-[8px] hover:bg-[#074CA4]/80 transition w-full sm:w-auto">
