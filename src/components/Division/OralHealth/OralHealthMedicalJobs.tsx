...
export default function OralHealthJobsByProfession() {
    return (
            ...
            <div className="inner-width-section mx-auto space-y-10">
                ...
                <div className="text-center">
                    <h2 className="text-2xl lg:text-[40px] font-[400] text-gray-800 mb-4">
                        Featured <span className="text-[#074CA4] font-bold">Oral Health Roles</span>
                    </h2>

                    <p className="text-gray-600 text-xs lg:text-[16px]">
We support General Practitioners across permanent registrar international pathway and locum roles helping you find opportunities that match your qualifications experience and career goals.
                    </p>
                </div>
                <div>
