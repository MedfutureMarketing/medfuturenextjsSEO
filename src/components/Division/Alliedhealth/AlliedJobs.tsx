...
export default function AlliedJJobsByProfession() {
    return (
        <section className="full-width-section  py-10 px-4 lg:px-0">
            <div className="inner-width-section mx-auto space-y-10">
                {/* Header */}
                <div className="text-center">
                    <h2 className="text-2xl lg:text-[40px] font-[400] text-gray-800 mb-4">
                        Featured <span className="text-[#074CA4] font-bold">Allied Health Roles</span>
                    </h2>

                    <p className="text-gray-600 text-xs lg:text-[16px]">
We recruit across Australia for in-demand Allied Health roles, delivering tailored staffing solutions for both permanent and locum requirements. Our focus ensures quality placements that support patient outcomes and long-term workforce stability.
                    </p>
                </div>
                <div>
