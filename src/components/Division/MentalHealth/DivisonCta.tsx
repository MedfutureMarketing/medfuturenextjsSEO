...
const contentMap: Record<string, { h2: string; p: string; button: string }> = {
    ...
    "/medical": {
        h2: "Advance Your Medical Career Today",
        p: "Explore medical practitioner roles across Australia that match your expertise and ambitions. Register now to unlock new opportunities and grow your career.",
        button: "Find your next Medical role"
    },
    "/allied-health": {
