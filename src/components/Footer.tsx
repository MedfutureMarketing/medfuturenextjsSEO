...
// 🔹 Add any path prefixes here to hide the footer on those pages
const HIDDEN_ON: string[] = [
  "/my-account/candidate",
  "/sign-up",
  "/employer-hub",
];
      ...
      <div className="inner-width-section">
        <div className=" ">
          ...
          <div className="py-16">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
              ...
              <div className="max-w-md">
                <Image src={logo} alt="medfuture logo" width={224} height={50} priority={false} loading="lazy" />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 md:grid-cols-3 gap-8 pt-8 pb-[54px]">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm lg:text-[14px] text-[#E2E8F0]">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm lg:text-[14px] text-[#E2E8F0]">
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <a href="tel:1300633388" className="hover:underline">
                    1300 633 388
                  </a>
                </li>
                ...
                {/* <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:notify@medfuture.co.au" className="hover:text-white transition-colors">
                    notify@medfuture.co.au
                  </a>
                </li>
                <li className="flex items-center gap-2">
        ...
        <div className="border-t inner-width-section border-gray-700 mt-5 py-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm md:mb-0">
            ...
            <Link href="/privacy-policy" className="hover:text-[#074CA4] px-2">Privacy Policy</Link>
            <Link href="/terms-and-conditions" className="hover:text-[#074CA4] px-2">Terms And Conditions</Link>
          </p>

          <div className="flex gap-4">
            <Link href="https://www.facebook.com/medfutureaustralia/" className="text-gray-400 hover:text-[#074CA4]" target="_blank" rel="noopener noreferrer">
            ...
            <Link href="https://www.instagram.com/medfutureglobal/?hl=en" className="text-gray-400 hover:text-[#074CA4]" target="_blank" rel="noopener noreferrer">
            ...
            <Link href="https://www.linkedin.com/company/medfuture-pty-ltd./" className="text-gray-400 hover:text-[#074CA4]" target="_blank" rel="noopener noreferrer">
              <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://www.youtube.com/@TheMedfuture" className="text-gray-400 hover:text-[#074CA4]" target="_blank" rel="noopener noreferrer">
              <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
