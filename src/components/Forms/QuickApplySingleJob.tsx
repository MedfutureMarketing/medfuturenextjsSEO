...
export default function RegistrationForm({ onClose }: RegistrationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit application - matching Laravel backend validation exactly
      // Extract numeric ID from jobId (e.g., PH28441 -> 28441)
      const numericJobId = jobId.replace(/\D/g, ''); // Remove all non-digits
  ...
  const inputClasses = "w-full px-[10px] px-[18px] lg:text-[16px] text-xs py-[13px] border border-[#E2E8F0] text-[#4A5565] rounded-md focus:outline-none focus:ring-2 focus:ring-[#64CAF3] focus:border-transparent placeholder:text-[#666666] text-sm sm:text-base";
  ...
  return (
    <div className="mt-4 sm:mt-8 p-4  lg:px-[117px] bg-white rounded-lg shadow-[0_6px_6px_rgba(0,0,0,0.05)] border-[#66768F]/16">
      <h3 className="lg:text-[30px]  text-xl text-sm font-600 lg:py-[35px] text-gray-900  text-center sm:text-center">Quick Apply</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 text-black" noValidate>
          ...
          <div className="relative">
            <PhoneInput
              ...
              inputProps={{
                id: "phone",
                autoComplete: "off",
                className: `w-full pl-16 lg:py-[20px] lg:text-[16px]  text-xs py-4 focus:outline-none bg-white border ${formErrors.phone ? 'border-red-300' : 'border-[#e6e8ebff]'
                  } rounded-md lg:h-[60px] px-3`,
              }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-[29px]">
          <div className="relative">
            <select
              ...
              className={`${inputClasses} ${formErrors.profession ? 'border-red-300' : ''} ${lockedProfessionId !== null ? 'bg-gray-100 cursor-not-allowed' : ''} appearance-none pr-10`}
            >
          ...
          <div className="relative">
            <select
              ...
              className={`${inputClasses} ${formErrors.specialty ? 'border-red-300' : ''} appearance-none pr-10`}
            >
          ...
          <div className="relative">
            <div className="relative">
              ...
              >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 text-[#4A5565] ml-2 flex-shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
        ...
        <div className="grid lg:grid-cols-2 lg:items-start  lg:mt-[43px]  mt-8 mb-[63px]">
          ...
          <div className="flex lg:justify-end justify-center gap-3 sm:gap-4 lg:mt-0 mt-8">
            <button
              ...
              className="bg-[#074CA4] text-white px-6 sm:px-8 h-[48px]  lg:text-[16px] text-xs cursor-pointer rounded-[4px] hover:bg-[#55b8e0] transition-colors font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="bg-gray-300  text-white px-6 sm:px-8 h-[48px]  lg:text-[16px] text-xs cursor-pointer rounded-[4px] hover:bg-gray-400 transition-colors font-medium"
            >
              Cancel
            </button>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-4 transform animate-slideUp">
            ...
            <button
              ...
              className="w-full bg-[#64CAF3] text-white px-6 py-3 cursor-pointer rounded-lg hover:bg-[#55b8e0] transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
            >
              Close
            </button>
          </div>
