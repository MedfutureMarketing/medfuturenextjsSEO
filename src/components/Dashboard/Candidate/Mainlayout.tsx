...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
    ...
    // Optimize resize handler with useCallback and debounce
    useEffect(() => {
        ...
        const checkScreenSize = () => {
            ...
            // Only auto-toggle on initial load or when crossing the breakpoint
            if (mobile) {
    ...
    // Memoize close handler for mobile
    ...
    return (
        <div className="full-width-section">
            <div className="flex h-screen bg-gray-50">
                ...
                {/* Content Area */}
                <div className="flex flex-col flex-1 min-w-0"> {/* Added min-w-0 to prevent flex overflow */}
                    {header}
